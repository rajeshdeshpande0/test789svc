...
import pom.infy.test789svc.web.rest.errors.BadRequestAlertException;
import pom.infy.test789svc.web.rest.util.HeaderUtil;
...
public class CustomerResource {
    ...
    private static final String ENTITY_NAME = "test789SvcCustomer";
