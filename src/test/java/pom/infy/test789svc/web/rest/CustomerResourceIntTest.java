package pom.infy.test789svc.web.rest;

import pom.infy.test789svc.Test789SvcApp;

import pom.infy.test789svc.domain.Customer;
import pom.infy.test789svc.repository.CustomerRepository;
import pom.infy.test789svc.service.CustomerService;
import pom.infy.test789svc.web.rest.errors.ExceptionTranslator;
...
import static pom.infy.test789svc.web.rest.TestUtil.createFormattingConversionService;
...
@SpringBootTest(classes = Test789SvcApp.class)
